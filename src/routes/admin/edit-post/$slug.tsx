...
export const Route = createFileRoute('/admin/edit-post/$slug')({
  loader: async ({ params }) => {
    try {
...
function EditPost() {
  ...
  const handlePublish = async () => {
    ...
    setLoading(true)
    try {
      await updatePostFn({ data: { slug: post.slug, title, summary, content } })
  ...
  return (
    <div className="animate-in fade-in duration-500 pb-20">
      <SectionLabel number="01" label="EDIT POST" />
